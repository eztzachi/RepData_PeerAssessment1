...
```
* Mean: `r format(totalStepsByDayMean, nsmall=4)`
* Median:  `r format(totalStepsByDayMedian, nsmall=4)`
...
Total number of missing values in the dataset: `r misisingValuesCount`
...
```
* Mean: `r format(filledNaData.totalStepsByDayMean, nsmall=4)`
* Median:  `r format(filledNaData.totalStepsByDayMedian, nsmall=4)`
